...
export default function LanguageSwitcher() {
  ...
  return (
    <>
      ...
      <div className="fixed top-6 start-6 z-50 flex gap-2">
        <a 
          href="https://github.com/NassimMahmoudi" 
          target="_blank" 
        ...
        <div className="terminal-glass p-1 rounded-full glow-border flex">
          {languages.map((lang) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-mono transition-all flex items-center gap-2 cursor-pointer ${
                language === lang.code
